defmodule Mix.Tasks.Tailwind.Gen.Html do
  @shortdoc "Generates controller, views, and context for an HTML resource using Tailwind"
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise(
        "mix tailwind.gen.html must be invoked from within your *_web application root directory"
      )
    end
